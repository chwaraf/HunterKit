...
local KNOWN_GLOBALS = {
  ...
  RefreshAmmoBuy = true, RefreshThreat = true,
}
local stray = {}
...
-- Pet aggro warning, Gun Sound, Passive pet alert, Positions, Reset.
check("every section has a divider rule", #rules == 11, tostring(#rules))
local spanning = 0
