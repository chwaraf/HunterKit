...
Current version: **0.9.78** — see [`CHANGELOG.md`](CHANGELOG.md).
...
Add `--verbose` to also echo the addon's chat output. **1068 checks**, in **9** files:
