...
Current version: **0.9.90** — see [`CHANGELOG.md`](CHANGELOG.md).
...
Add `--verbose` to also echo the addon's chat output. **1192 checks**, in **9** files:
