...
Current version: **0.9.62** — see [`CHANGELOG.md`](CHANGELOG.md).
...
| **Macros** | A small library of hunter macros in their own window, each with a short explanation. Click to select, Ctrl+C to copy. |
