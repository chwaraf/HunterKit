...
Current version: **0.9.74** — see [`CHANGELOG.md`](CHANGELOG.md).
...
Add `--verbose` to also echo the addon's chat output. **1043 checks**, in **9** files:
