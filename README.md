...
Current version: **0.9.76** — see [`CHANGELOG.md`](CHANGELOG.md).
...
Add `--verbose` to also echo the addon's chat output. **1053 checks**, in **9** files:
